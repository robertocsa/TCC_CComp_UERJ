...
public class RecPyForm 
	...
	private static final long serialVersionUID = 385962866588104562L;
	...
	public RecPyForm(){
		setTitle("RecPy: Pre-Compiler for recursive functions in Python");
		setBounds(20, 20, 1000, 680); 
        ...
        lbJanOrig.setSize(400, 25); 
        lbJanOrig.setLocation(20, 2); 
        lbJanOrig.setText("    The Tail Recursive code to translate:");
        jplLabels.add(lbJanOrig, BorderLayout.LINE_START); 
        
        lbJanDest = new JLabel(); 
        lbJanDest.setFont(new Font("Arial", Font.PLAIN, 17)); 
        lbJanDest.setSize(400, 25); 
        lbJanDest.setLocation(500, 2); 
        lbJanDest.setText("The Iterative correspondent code: "+ repeatStr(" ",38));
        ...
        //-----------------------------------------------                
        txtOrig = new JTextArea(300,500); 
        //txtOrig.setLocation(20, 30);
        txtOrig.setFont(new Font("Arial", Font.PLAIN, 16));
        JScrollPane scrollPaneOrig = new JScrollPane(txtOrig);
        scrollPaneOrig.setPreferredSize(new Dimension(500, 300));          
        ...
        txtDest = new JTextArea(300,500); 
        //txtDest.setLocation(500, 30);
        JScrollPane scrollPaneDest = new JScrollPane(txtDest);
        scrollPaneDest.setPreferredSize(new Dimension(400, 300));        
        ...
        scrollPaneDest.setPreferredSize(new Dimension(200,300));
        ...
        translations = new JRadioButton[] {
				new JRadioButton("Tail Recursive to Iterative       ", true),
				new JRadioButton("Non Tail Recursive to Tail Recursive     "),
				new JRadioButton("Non Tail Recursive to Iterative     "),
				new JRadioButton("Iterative to Tail Recursive         ")
				};
		// botões seletores de tipo de tradução:
			...
			(translations[i]).addActionListener(new ActionListener() {				 
			    ...
			    public void actionPerformed(ActionEvent event) {			 
			    	if (translations[1].isSelected()|| translations[3].isSelected()) {			    		
						lbJanDest.setText("The Tail Recursive correspondent code: " + repeatStr(" ",38));
						if (translations[1].isSelected()) {
							lbJanOrig.setText("   The Non Tail Recursive code to translate:");
						} else {
							lbJanOrig.setText("   The Iterative code to translate:");
						}
					} else {
						lbJanDest.setText("The Iterative correspondent code: "+ repeatStr(" ",38));
        ...
        btSave = new JButton("Save result"); 
        ...
        btCopy = new JButton("Copy result"); 
        ...
        btClear = new JButton("Clear result"); 
